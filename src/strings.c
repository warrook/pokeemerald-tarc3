...
const u8 gText_DadsAdvice[] = _("Banzo's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_LanettesPC[] = _("Lander's PC");
...
const u8 gText_TrainerCardIDDashes[] = _("-----");
const u8 gText_TrainerCardMoney[] = _("CHARGE");
const u8 gText_PokeDollar[] = _("¥"); // Unused
const u8 gText_TrainerCardPokedex[] = _("EXO-DEX");
const u8 gText_EmptyString6[] = _("");
const u8 gText_Colon2[] = _(":");
const u8 gText_Points[] = _(" points"); // Unused
const u8 gText_TrainerCardTime[] = _("EVA TIME");
const u8 gText_TrainerCardTimeBlank[] = _("0:00");
...
const u8 gText_StartGame[] = _("{START_BUTTON}PLAY");