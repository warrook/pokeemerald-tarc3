...
const u16 gTamagotchiTrainerCard_Pal[] = INCGFX_U16("graphics/trainer_card/tama_tiles.png", ".gbapal");
...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/tama_title_logo.gbapal",
                                                        "graphics/title_screen/tama_title_background_tiles.gbapal");
const u16 gTitleScreenBgPalette[]          = INCBIN_U16("graphics/title_screen/tama_title_background_tiles.gbapal");
