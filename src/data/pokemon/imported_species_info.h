...
[SPECIES_MIMITCHI] =
{
    ...
    .categoryName = _("Land Toddle"),
    .frontPic = gMonFrontPic_Mimitchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Mimitchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Mimitchi,
...
[SPECIES_MOLMOTCHI] =
{
    ...
    .categoryName = _("Land Toddle"),
    .frontPic = gMonFrontPic_Molmotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Molmotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Molmotchi,
    .shinyPalette = gMonShinyPalette_Molmotchi,
    .iconSprite = gMonIcon_Molmotchi,
    .iconPalIndex = 5,
    FOOTPRINT(Molmotchi)
...
[SPECIES_LEOPATCHI] =
{
    ...
    .backPic = gMonBackPic_Leopatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Leopatchi,
    .shinyPalette = gMonShinyPalette_Leopatchi,
    .iconSprite = gMonIcon_Leopatchi,
    .iconPalIndex = 3,
    FOOTPRINT(Leopatchi)
...
[SPECIES_TUSTUSTCHI] =
{
    ...
    .categoryName = _("Land Sprout"),
    .frontPic = gMonFrontPic_Tustustchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Tustustchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Tustustchi,
    .shinyPalette = gMonShinyPalette_Tustustchi,
    .iconSprite = gMonIcon_Tustustchi,
    .iconPalIndex = 1,
    FOOTPRINT(Tustustchi)
...
[SPECIES_CHODRACOTCHI] =
{
    ...
    .frontPic = gMonFrontPic_Chodracotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Chodracotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Chodracotchi,
    .shinyPalette = gMonShinyPalette_Chodracotchi,
    .iconSprite = gMonIcon_Chodracotchi,
    .iconPalIndex = 4,
    FOOTPRINT(Chodracotchi)
...
[SPECIES_IRUKATCHI] =
{
    ...
    .backPic = gMonBackPic_Irukatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Irukatchi,
    .shinyPalette = gMonShinyPalette_Irukatchi,
    .iconSprite = gMonIcon_Irukatchi,
    .iconPalIndex = 3,
    FOOTPRINT(Irukatchi)
...
[SPECIES_URUOTCHI] =
{
    ...
    .categoryName = _("Water Glide"),
    .frontPic = gMonFrontPic_Uruotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Uruotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
...
[SPECIES_AXOLOPATCHI] =
{
    ...
    .backPic = gMonBackPic_Axolopatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Axolopatchi,
    .shinyPalette = gMonShinyPalette_Axolopatchi,
    .iconSprite = gMonIcon_Axolopatchi,
    .iconPalIndex = 0,
    FOOTPRINT(Axolopatchi)
...
[SPECIES_IMORITCHI] =
{
    ...
    .backPic = gMonBackPic_Imoritchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Imoritchi,
    .shinyPalette = gMonShinyPalette_Imoritchi,
    .iconSprite = gMonIcon_Imoritchi,
    .iconPalIndex = 2,
    FOOTPRINT(Imoritchi)
...
[SPECIES_KAWAZUTCHI] =
{
    ...
    .categoryName = _("Water Leap"),
    .frontPic = gMonFrontPic_Kawazutchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Kawazutchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Kawazutchi,
    .shinyPalette = gMonShinyPalette_Kawazutchi,
    .iconSprite = gMonIcon_Kawazutchi,
    .iconPalIndex = 1,
    FOOTPRINT(Kawazutchi)
...
[SPECIES_TACHUTCHI] =
{
    ...
    .backPic = gMonBackPic_Tachutchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Tachutchi,
    .shinyPalette = gMonShinyPalette_Tachutchi,
    .iconSprite = gMonIcon_Tachutchi,
    .iconPalIndex = 0,
    FOOTPRINT(Tachutchi)
...
[SPECIES_SHARKTCHI] =
{
    ...
    .backPic = gMonBackPic_Sharktchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Sharktchi,
    .shinyPalette = gMonShinyPalette_Sharktchi,
    .iconSprite = gMonIcon_Sharktchi,
    .iconPalIndex = 0,
    FOOTPRINT(Sharktchi)
...
[SPECIES_KURARATCHI] =
{
    ...
    .frontPic = gMonFrontPic_Kuraratchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Kuraratchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Kuraratchi,
    .shinyPalette = gMonShinyPalette_Kuraratchi,
    .iconSprite = gMonIcon_Kuraratchi,
    .iconPalIndex = 5,
...
[SPECIES_MENDAKOTCHI] =
{
    ...
    .categoryName = _("Water Float"),
    .frontPic = gMonFrontPic_Mendakotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Mendakotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Mendakotchi,
    .shinyPalette = gMonShinyPalette_Mendakotchi,
    .iconSprite = gMonIcon_Mendakotchi,
    .iconPalIndex = 3,
...
[SPECIES_AMEFURATCHI] =
{
    ...
    .categoryName = _("Water Float"),
    .frontPic = gMonFrontPic_Amefuratchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Amefuratchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Amefuratchi,
    .shinyPalette = gMonShinyPalette_Amefuratchi,
    .iconSprite = gMonIcon_Amefuratchi,
    .iconPalIndex = 3,
...
[SPECIES_HORHOTCHI] =
{
    ...
    .backPic = gMonBackPic_Horhotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Horhotchi,
    .shinyPalette = gMonShinyPalette_Horhotchi,
    .iconSprite = gMonIcon_Horhotchi,
    .iconPalIndex = 2,
    FOOTPRINT(Horhotchi)
...
[SPECIES_MONGATCHI] =
{
    ...
    .backPic = gMonBackPic_Mongatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Mongatchi,
    .shinyPalette = gMonShinyPalette_Mongatchi,
    .iconSprite = gMonIcon_Mongatchi,
    .iconPalIndex = 4,
    FOOTPRINT(Mongatchi)
...
[SPECIES_BATCHI] =
{
    ...
    .categoryName = _("Sky Flap"),
    .frontPic = gMonFrontPic_Batchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Batchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
...
[SPECIES_BATATCHI] =
{
    ...
    .backPic = gMonBackPic_Batatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Batatchi,
    .shinyPalette = gMonShinyPalette_Batatchi,
    .iconSprite = gMonIcon_Batatchi,
    .iconPalIndex = 3,
    FOOTPRINT(Batatchi)
...
[SPECIES_PAPILLOTCHI] =
{
    ...
    .backPic = gMonBackPic_Papillotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Papillotchi,
    .shinyPalette = gMonShinyPalette_Papillotchi,
    .iconSprite = gMonIcon_Papillotchi,
    .iconPalIndex = 0,
...
[SPECIES_TENTOTCHI] =
{
    ...
    .categoryName = _("Sky Bumble"),
    .frontPic = gMonFrontPic_Tentotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Tentotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Tentotchi,
    .shinyPalette = gMonShinyPalette_Tentotchi,
    .iconSprite = gMonIcon_Tentotchi,
    .iconPalIndex = 3,
    FOOTPRINT(Tentotchi)
...
[SPECIES_GEMTCHI] =
{
    ...
    .backPic = gMonBackPic_Gemtchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Gemtchi,
    .shinyPalette = gMonShinyPalette_Gemtchi,
    .iconSprite = gMonIcon_Gemtchi,
    .iconPalIndex = 4,
    FOOTPRINT(Gemtchi)
...
[SPECIES_ORETATCHI] =
{
    ...
    .backPic = gMonBackPic_Oretatchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Oretatchi,
    .shinyPalette = gMonShinyPalette_Oretatchi,
    .iconSprite = gMonIcon_Oretatchi,
    .iconPalIndex = 2,
    FOOTPRINT(Oretatchi)
...
[SPECIES_ISHIKOROTCHI] =
{
    ...
    .categoryName = _("Sky Rocky"),
    .frontPic = gMonFrontPic_Ishikorotchi,
    .frontPicSize = MON_COORDS_SIZE(64, 64),
    .frontAnimFrames = ANIM_FRAMES(
        ANIMCMD_FRAME(0,1),
    ),
    .backPic = gMonBackPic_Ishikorotchi,
    .backPicSize = MON_COORDS_SIZE(64, 64),
    .backPicYOffset = 13, //default
    .palette = gMonPalette_Ishikorotchi,
    .shinyPalette = gMonShinyPalette_Ishikorotchi,
    .iconSprite = gMonIcon_Ishikorotchi,
    .iconPalIndex = 0,
    FOOTPRINT(Ishikorotchi)
