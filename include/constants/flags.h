...
// Tamagotchi
#define TAMAGOTCHI_FLAGS_START      FLAG_HIDE_SKY_PILLAR_TOP_RAYQUAZA_STILL //0x50
#define FLAG_LEARNED_BABY_EVO       (TAMAGOTCHI_FLAGS_START + 0x0)
#define FLAG_LEARNED_TEEN_EVO       (TAMAGOTCHI_FLAGS_START + 0x1)
#define FLAG_LEARNED_ADULT_EVO      (TAMAGOTCHI_FLAGS_START + 0x2)
#define FLAG_EVOLVED_MON            (TAMAGOTCHI_FLAGS_START + 0x3)
#define FLAG_FIRST_PALOOKA          (TAMAGOTCHI_FLAGS_START + 0x4)
#define FLAG_EXP_SHARE              (TAMAGOTCHI_FLAGS_START + 0x5)
#define FLAG_WATER_GUARD_DEFEATED   (TAMAGOTCHI_FLAGS_START + 0x7)
#define FLAG_LAND_GUARDS_DEFEATED   (TAMAGOTCHI_FLAGS_START + 0x8)
#define FLAG_SKY_GUARD_DEFEATED     (TAMAGOTCHI_FLAGS_START + 0x9)
#define FLAG_JOMO_DEFEATED          (TAMAGOTCHI_FLAGS_START + 0xA)
#define FLAG_CAUGHT_SHINIGAMI       (TAMAGOTCHI_FLAGS_START + 0xB)
#define FLAG_CAUGHT_KURITEN         (TAMAGOTCHI_FLAGS_START + 0xC)

#define TAMAGOTCHI_EVENT_FLAGS_START    FLAG_HIDE_ROUTE_101_BIRCH_STARTERS_BAG //0x2BC
#define FLAG_HIDE_TRAINER_BEACH_A       (TAMAGOTCHI_EVENT_FLAGS_START + 0x0)
#define FLAG_HIDE_TRAINER_BEACH_B       (TAMAGOTCHI_EVENT_FLAGS_START + 0x1)
#define FLAG_HIDE_TRAINER_BEACH_C       (TAMAGOTCHI_EVENT_FLAGS_START + 0x2)
#define FLAG_HIDE_TRAINER_WATER_GUARD   (TAMAGOTCHI_EVENT_FLAGS_START + 0x3)
#define FLAG_HIDE_FIRST_PALOOKA         (TAMAGOTCHI_EVENT_FLAGS_START + 0x4)
#define FLAG_HIDE_SECOND_PALOOKA        (TAMAGOTCHI_EVENT_FLAGS_START + 0x5)
#define FLAG_HIDE_TRAINER_LAND_A        (TAMAGOTCHI_EVENT_FLAGS_START + 0x6)
#define FLAG_HIDE_TRAINER_LAND_B        (TAMAGOTCHI_EVENT_FLAGS_START + 0x7)
#define FLAG_HIDE_TRAINER_LAND_C        (TAMAGOTCHI_EVENT_FLAGS_START + 0x8)
#define FLAG_HIDE_TRAINER_LAND_D        (TAMAGOTCHI_EVENT_FLAGS_START + 0x9)
#define FLAG_HIDE_TRAINER_LAND_E        (TAMAGOTCHI_EVENT_FLAGS_START + 0xA)
#define FLAG_HIDE_TRAINER_LAND_GUARD_L  (TAMAGOTCHI_EVENT_FLAGS_START + 0xB)
#define FLAG_HIDE_TRAINER_LAND_GUARD_R  (TAMAGOTCHI_EVENT_FLAGS_START + 0xC)
#define FLAG_HIDE_TRAINER_SKY_A         (TAMAGOTCHI_EVENT_FLAGS_START + 0xD)
#define FLAG_HIDE_TRAINER_SKY_B         (TAMAGOTCHI_EVENT_FLAGS_START + 0xE)
#define FLAG_HIDE_TRAINER_SKY_C         (TAMAGOTCHI_EVENT_FLAGS_START + 0xF)
#define FLAG_HIDE_TRAINER_SKY_D         (TAMAGOTCHI_EVENT_FLAGS_START + 0x10)
#define FLAG_HIDE_TRAINER_SKY_E         (TAMAGOTCHI_EVENT_FLAGS_START + 0x11)
#define FLAG_HIDE_TRAINER_SKY_GUARD     (TAMAGOTCHI_EVENT_FLAGS_START + 0x12)
#define FLAG_HIDE_JOMO                  (TAMAGOTCHI_EVENT_FLAGS_START + 0x13)
