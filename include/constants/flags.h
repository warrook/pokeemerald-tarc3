...
#define FLAG_HIDE_TRAINER_BEACH_D       (TAMAGOTCHI_EVENT_FLAGS_START + 0x3)
#define FLAG_HIDE_TRAINER_BEACH_E       (TAMAGOTCHI_EVENT_FLAGS_START + 0x4)
#define FLAG_HIDE_TRAINER_WATER_GUARD   (TAMAGOTCHI_EVENT_FLAGS_START + 0x5)
#define FLAG_HIDE_FIRST_PALOOKA         (TAMAGOTCHI_EVENT_FLAGS_START + 0x6)
#define FLAG_HIDE_SECOND_PALOOKA        (TAMAGOTCHI_EVENT_FLAGS_START + 0x7)
